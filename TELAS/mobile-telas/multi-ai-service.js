...
// ⭐ LLAMA-3.1-8B PRIMEIRO (mais rápido)
// ⭐ LLAMA-3.3-70B SEGUNDO (melhor qualidade)
...
class MultiAIService {
    constructor() {
        ...
        // ⭐ ORDEM CORRIGIDA - CONFORME IMAGENS
        // 1º - llama-3.1-8b-instant (RÁPIDO - primeira imagem)
        // 2º - llama-3.3-70b-versatile (QUALIDADE - segunda imagem)
        // 3º - mixtral-8x7b-32768 (fallback)
        // 4º - openai/gpt-oss-120b (pode não existir)
        // 5º - qwen/qwen3.6-27b (ÚLTIMO - pensamentos em inglês)
        this.GROQ_MODELS = [
            "llama-3.1-8b-instant",       // 1º - RÁPIDO
            "llama-3.3-70b-versatile",    // 2º - QUALIDADE
            "mixtral-8x7b-32768",         // 3º - Fallback
            "openai/gpt-oss-120b",        // 4º - Pode não existir
    ...
    async _callGroqAPI(prompt, context, model) {
        ...
        // ⭐ SYSTEM PROMPT MUITO AGRESSIVO CONTRA PENSAMENTOS
