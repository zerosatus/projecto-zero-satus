// ============================================
// multi-ai-service.js - POLLINATIONS.AI (SEM CHAVE)
// ============================================
...
class MultiAIService {
    constructor() {
        // ⭐ REMOVA A CHAVE - NÃO É NECESSÁRIA!
        ...
        console.log('[MultiAI] 📌 Modo: ANÔNIMO (sem chave) - 100% gratuito');
        this._resetarLimite();
    ...
    async _callAPI(prompt, context) {
        ...
        console.log('[Pollinations] 📡 Modo: ANÔNIMO');
...
console.log('[MultiAI] 📌 Modo: ANÔNIMO - 100% gratuito, sem chave!');
