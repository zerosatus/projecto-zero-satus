...
console.log('%c📱 Mobile Otimizado - Com remoção de horários e sincronização completa', 'color: #10b981; font-size: 16px; font-weight: bold;');// mobile-telas/script.js - VERSÃO COMPLETA COM REMOÇÃO DE HORÁRIOS E SINCRONIZAÇÃO
