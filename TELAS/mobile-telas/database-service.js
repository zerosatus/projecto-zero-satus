// database-service.js - Serviço completo de banco de dados Supabase (COM LOGS DETALHADOS)
...
const DatabaseService = (function() {
    ...
    async function getUserProfile(userId) {
        ...
        try {
            ...
            console.log('[Database] 📦 Dados:', JSON.stringify(data, null, 2));
            ...
            // Log completo do perfil
            console.log('[Database] 📊 Perfil completo:', JSON.stringify(data, null, 2));
    ...
    async function uploadProfilePhoto(userId, file) {
        ...
        try {
            ...
            const { data: { publicUrl } } = client.storage                .from('user-content')
